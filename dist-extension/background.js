...
/* harmony import */ var _utils_webScraper_extension__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/webScraper.extension */ "./src/utils/webScraper.extension.js");
...
function sendMessageToAudius(data) {
  ...
  Promise.all([webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.query({
    url: 'http://localhost:8080/'
  }), webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.query({
    url: 'https://audius.rockdapus.org/'
  })]).then(function (tabsLists) {
    return tabsLists.reduce(function (acc, tabs) {
      return _toConsumableArray(acc).concat(_toConsumableArray(tabs));
    }, []);
  }).then(function (tabs) {
    if (!(tabs && tabs.length)) {
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(event) {
    var urls, promises, i, data, _promises, _i, mediaList;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            promises = urls.map(function (url) {
              return _utils_webScraper_extension__WEBPACK_IMPORTED_MODULE_2__["webScraper"][event.data.type](url);
            });
            i = 0;
          ...
          case 9:
            data = _context.sent;
            sandbox.contentWindow.postMessage(Object.assign(event.data.responseTemplate, {
              id: event.data.id,
              data: data
            }), '*');
            _context.next = 13;
          ...
          case 23:
            if (!(event.data.type === 'scanUrl')) {
              _context.next = 44;
              break;
            }

            _promises = _utils_webScraper_extension__WEBPACK_IMPORTED_MODULE_2__["webScraper"].scanUrl(event.data);
            _i = 0;
          ...
          case 44:
            if (event.data.type === 'scanOneUrl') {
              _utils_webScraper_extension__WEBPACK_IMPORTED_MODULE_2__["webScraper"][event.data.type](event.data).then(function (mediaList) {
                sendMessageToAudius({
                  audius: true,
                  vuex: 'dispatch',
                  type: 'webScraperUpdateSuccess',
...
setTimeout(function () {
  sandbox.contentWindow.postMessage({
    type: 'handshakeSandbox'
  }, '*');
}, 500);

function patternMatcher2regEx(text) {
  var pattern = text.split('*').map(function (s) {
    return s.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&');
  }).join('.*');
  return "^".concat(pattern, "$");
}

webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.onUpdated.addListener(function (event) {
  webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.get(event).then(function (tab) {
    if (tab.status === 'complete') {
      var watch = Object.values(watchList).find(function (_ref2) {
        var urlRegEx = _ref2.urlRegEx;
        return urlRegEx.test(tab.url);
      });

      if (watch) {
        webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.sendMessage(tab.id, {
          audius: true,
          type: 'startWatching',
          id: watch.id,
          css: watch.css
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.runtime.onMessage.addListener(
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            request.watchList.forEach(function (item) {
              if (item.id in watchList && watchList[item.id].url !== item.url) {
                webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.query({
                  url: watchList[item.id].url
                }).then(function (tabs) {
                  return Promise.all(tabs.map(function (tab) {
                    return webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default.a.tabs.sendMessage(tab.id, {
                      audius: true,
                      type: 'stopWatching'
                    });
                  }));
              ...
              watchList[item.id] = Object.assign(item, {
                urlRegEx: new RegExp(patternMatcher2regEx(item.url))
              });
            });
            _context2.next = 35;
            break;
          ...
          case 12:
            ...
            promises = _utils_webScraper_extension__WEBPACK_IMPORTED_MODULE_2__["webScraper"].scanUrl(request);
            i = 0;
          ...
          case 19:
            ...
            data = Object.assign({}, request.responseTemplate.data, {
              mediaList: mediaList
            });
            sendMessageToAudius(Object.assign({}, request.responseTemplate, {
              data: data
            }));
            _context2.next = 24;
            return delay(2000);
          ...
          case 34:
            if (request.type === 'webScraperUpdateSuccess') {
