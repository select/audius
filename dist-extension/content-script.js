...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/video-item.component\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../components/youtube-player.component\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	if (({"extension":true}).NODE_ENV !== 'production' && typeof isCrushed.name === 'string' && isCrushed.name !== 'isCrushed') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function combineReducers(reducers) {
	  ...
	  for (var i = 0; i < reducerKeys.length; i++) {
	    ...
	    if (({"extension":true}).NODE_ENV !== 'production') {
...
/***/ function(module, exports) {
	...
	var setYoutubeApiKey = exports.setYoutubeApiKey = function setYoutubeApiKey(youtubeApiKey) {
		return {
	...
	var setPastebinApiKey = exports.setPastebinApiKey = function setPastebinApiKey(pastebinApiKey) {
		return {
...
/***/ function(module, exports) {
	...
	var toggleExport = exports.toggleExport = function toggleExport(state) {
		return {
			type: 'TOGGLE_EXPORT',
			state: state
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pastebinRegEx = /http:\/\/pastebin.com\/(\w{8})/;
			...
			return function (action) {
				...
				if (action.type === 'IMPORT_URL') {
					if (pastebinRegEx.test(action.url)) {
						var match = pastebinRegEx.exec(action.url);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
		...
		currentPlayList: '',
		editPlayList: false,
		youtubeApiKey: _config.youtubeApiKey,
		pastebinApiKey: _config.pastebinApiKey
	};
	...
	function next(state) {
		...
		if (state.queue.length) {
			...
			return Object.assign({}, state, {
				mediaId: mediaId,
				stepsHistoryBack: 0,
				sessionHistory: [].concat(_toConsumableArray(state.sessionHistory), [state.currentMedia.id]),
	...
	var mediaPlayer = function mediaPlayer() {
		...
		switch (action.type) {
			...
			case 'SET_YOUTUBE_API_KEY':
				{
					if (!action.youtubeApiKey) return Object.assign({}, state, { youtubeApiKey: _config.youtubeApiKey });
					return Object.assign({}, state, { youtubeApiKey: action.youtubeApiKey });
				}
			case 'SET_PASTEBIN_API_KEY':
				{
					if (!action.pastebinApiKey) return Object.assign({}, state, { pastebinApiKey: _config.pastebinApiKey });
...
/***/ function(module, exports) {
	...
	var youtubeApiKey = exports.youtubeApiKey = 'AIzaSyCHVgsa5owudn4G79IX9pcRcrVNOmgKHuM';
	var pastebinApiKey = exports.pastebinApiKey = '297f2f56e2e6b887d1a36e4d80bee5bf';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function findVideos() {
		var YOUTUBE_API_KEY = _store2.default.getState().mediaPlayer.youtubeApiKey;
